...
public class Server extends JFrame implements ActionListener
{
    ...
    Server()
    {
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icon/jim_gordorn.jpg"));
        ...
        ImageIcon i7=new ImageIcon(ClassLoader.getSystemResource("icon/video.jpg"));
        ...
        ImageIcon i10=new ImageIcon(ClassLoader.getSystemResource("icon/phone.jpg"));
        ...
        ImageIcon i13=new ImageIcon(ClassLoader.getSystemResource("icon/3circle.jpg"));
